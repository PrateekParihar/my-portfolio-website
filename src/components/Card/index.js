...
function Card(props) {
  ...
  if (source) {
    cardSubContent = (
      <React.Fragment>
        {role && <p className={styles.cardNotesSpan}>{role}</p>}
        {topics && <p className={styles.cardNotesSpan}>{topics}</p>}
    ...
    cardSubContent = (
      <React.Fragment>
        {role && <p className={styles.cardWorkSpan}>{role}</p>}
        {topics && <p className={styles.cardWorkSpan}>{topics}</p>}
      </React.Fragment>
    );
  }
